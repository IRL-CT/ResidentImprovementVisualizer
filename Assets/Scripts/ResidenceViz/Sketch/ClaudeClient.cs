...
// The one place in ResidenceViz that touches the network.
//
...
// else about a residence stays on the machine.
//
// It is a plain class, and the coroutine is hosted by ResidenceEditController, which is already a
