...
// else on screen.
//
// Still a plain class, not a MonoBehaviour. ResidenceEditController owns one and calls Draw from its OnGUI,
...
public class TimelineBar
{
    ...
    //
    // The argument the timeline exists to make is that a residence is a place where things happen at
    ...
    // with no room is time away from residence.
