...
// shared-home / assisted-living cases the tool is aimed at, so their doors are all 36" and step-free
...
public static class SampleHomes
{
    ...
    ///
    /// It exists because seeding is one-shot. `HomeSettings.samplesSeeded` deliberately stops the
    ...
    /// the six homes sitting in the library still had a wardrobe across a cased opening, a bath
    /// across a bathroom door and a dresser across a bedroom door long after the tests were green.
    ///
    /// Every installed sample carries the generation it was built from (HomeDoc.sampleGeneration),
    /// and SampleHomeInstaller.RefreshStaleSamples re-installs any that has fallen behind AND that
    ...
    public static HomeDoc Build(string key)
    {
        ...
        return new HomeDoc
        {
            ...
            // home as it is; the proposal is one click away in the mode band, and Compare is what it
            // is for.
    ...
    /// SmartHomeReport.pdf: §2.2.2's group homes, §5.3's CFS family homes, five residents and the
    ...
    /// before. HomeViz is a before/after tool, and "what does this home look like with the technology
    ...
    private static VariantDef TechnologyProposal(string key, VariantDef baseline)
    {
        ...
        // home removed and an entire home added.
        ...
        var proposal = new VariantDef
        {
            ...
            description =
                ...
                + "for this home: every way out watched, movement sensing through the corridor and "
