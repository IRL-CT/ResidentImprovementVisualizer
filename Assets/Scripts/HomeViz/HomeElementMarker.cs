...
//
// The Brownfield renderer uses one tiny marker component per element type (InstanceMarker, PathMarker,
...
public class HomeElementMarker : MonoBehaviour
{
    public enum Kind { Wall, Opening, Room, Floor, Ceiling, Furniture, WallMount }
